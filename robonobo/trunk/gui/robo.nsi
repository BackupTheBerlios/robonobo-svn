...
; Adapted from http://nsis.sourceforge.net/Java_Launcher_with_automatic_JRE_installation
;-----------------------------------------------
!define ROBO_VERSION "test"
!define ROBO_EXE "target\dist\robonobo-test.exe"
Name "robonobo"
Caption "robonobo"
; Icon "Java Launcher.ico"
OutFile "robonobo-install-${ROBO_VERSION}.exe"
 
VIAddVersionKey "ProductName" "robonobo"
VIAddVersionKey "Comments" ""
VIAddVersionKey "CompanyName" "The robonobo project"
;VIAddVersionKey "LegalTrademarks" "Java Launcher is a trademark of Fake company"
;VIAddVersionKey "LegalCopyright" "Fake company"
;VIAddVersionKey "FileDescription" "Robonobo is a music sharing application"
VIAddVersionKey "FileVersion" ${ROBO_VERSION}
VIProductVersion 0.0.0.0
 
;!define CLASSPATH "robonobo-${ROBO_VERSION}.jar"
;!define CLASS "com.robonobo.gui.RobonoboFrame"
...
; PAGES
Page license
	 LicenseText "All your base are belong to us."
Page directory
Page instfiles
...
Section "Uninstall"
  ...
  Delete $INSTDIR\robonobo-test.exe
  RMDir $INSTDIR
SectionEnd
