...
class BasicTransferable implements Transferable {
	...
	public DataFlavor[] getTransferDataFlavors() {
		...
		log.warn("*** getTransferDataFlavors called, returning "+flavorArrToString(flavors));
		return flavors;
	}

	private String flavorArrToString(DataFlavor[] flavors) {
	...
	public boolean isDataFlavorSupported(DataFlavor flavor) {
		log.warn("*** isDataFlavorSupported called");
	...
	public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
		log.warn("*** getTransferData called");
		DataFlavor[] richerFlavors = getRicherFlavors();
